...
function showNextDueDateDialog() {
  ...
  if (daysDifference === 0) {
    ...
    // If today is within the week BEFORE the closest due date, show the date in blue, "This Week:" and no font weight; Verified Working
    return `<p style="font-size: 18px; color: blue;">This Week: ${formatDate(nextDueDate)}</p>`;
  }
}
...
function testBlurbsDueToday() {
  ...
  const message = showNextDueDateDialog();
  console.log(message); // Log the message to the console instead of showing a dialog
